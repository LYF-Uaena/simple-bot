...
import love.forte.simbot.component.mirai.message.event.MiraiGroupMemberJoinRequest;
...
public class TestGroup extends BaseFilter implements ListenerFilter {
    ...
    public boolean test(@NotNull FilterData data) {
        ...
        log.info(msgGet.getAccountInfo().getAccountCode());
        log.info(msgGet.getClass().toString());
